...
export default function Show({ user }) {
    return (
        <CentralLayout title="Detalhes do Usuário">
            <Head title="Usuário" />
            <div className="max-w-2xl">
                <div className="card p-6 space-y-4">
                    ...
                    <div className="flex justify-end gap-3 pt-4 border-t">
                        <Link href={route('central.users.index')} className="btn-secondary">
                            Voltar
                        </Link>
                        <Link
                            href={route('central.users.edit', [user.tenant_id, user.id])}
