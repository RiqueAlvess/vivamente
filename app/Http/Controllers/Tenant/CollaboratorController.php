...
class CollaboratorController extends Controller
{
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('Tenant/Collaborators/Index', [
    ...
    {
        return Inertia::render('Tenant/Collaborators/Create');
    }
    ...
    {
        return Inertia::render('Tenant/Collaborators/Edit', [
            'collaborator' => $collaborator,
        ]);
    }
